...
class Servicio_extraordinario_model extends CI_Model {
    ...
    function update_servicio_extraordinario($guardar_servicio_extraordinario, $id_servicio) {
        $this->db->where('id_servicio', $id_servicio);
        //  $this->db->set('estado_aprobacion', 1);
        return $this->db->update('servicio_extraordinario', $guardar_servicio_extraordinario);
    }
    ...
    public function servicio_extraordinario_edit($id_servicio) {
        $this->db->select('*');
        //   $this->db->where("id_usuario", $this->session->userdata('id_usuario'));
        $this->db->where("id_servicio", $id_servicio);
        $this->db->join('gestion', 'gestion.id = servicio_extraordinario.gestion');
        $this->db->join('mes', 'mes.id = servicio_extraordinario.mes');
        $this->db->join('departamento', 'departamento.id = servicio_extraordinario.departamento');
        $this->db->join('provincia', 'provincia.id = servicio_extraordinario.provincia');
        $this->db->join('municipio', 'municipio.id = servicio_extraordinario.municipio');
        $this->db->join('localidad', 'localidad.id = servicio_extraordinario.localidad');
        $this->db->join('epis', 'epis.id = servicio_extraordinario.epis');
        $this->db->join('distrito', 'distrito.id = servicio_extraordinario.distrito');
        $this->db->join('zona', 'zona.id = servicio_extraordinario.zona');
   //     $this->db->join('denuncia', 'denuncia.id = auxilios.denuncia');
        ...
        $this->db->join('tipo_servicio_extraordinario', 'tipo_servicio_extraordinario.id = servicio_extraordinario.tipo_servicio_extraordinario');
    
        $this->db->join('remision_caso', 'remision_caso.id = servicio_extraordinario.remision_caso');
    ...
    //    $this->db->join('recurso_apelacion', 'recurso_apelacion.id = auxilios.recurso_apelacion');
        $this->db->join('servicio_destacado', 'servicio_destacado.id = servicio_extraordinario.servicio_destacado');

        $this->db->from('servicio_extraordinario');
        //  $this->db->order_by('id_producto', 'desc');
        //	$this->db->limit('2');
        $productos = $this->db->get();
        return $productos->result();
    ...
    public function guardar_servicio_extraordinario($guardar_servicio_extraordinario) {
        $this->db->insert('servicio_extraordinario', $guardar_servicio_extraordinario);
    }
