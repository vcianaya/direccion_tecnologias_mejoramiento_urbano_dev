...
class Nino_model extends CI_Model {
    ...
    function edad($c1, $c2) {
        $this->db->from('datosnino');
        $this->db->where('edad_nino >=', $c1);
        $this->db->where('edad_nino <=', $c2);
        return $this->db->count_all_results();
    }

    function sexo($s) {
        $this->db->from('datosnino');
        $this->db->where('sexo', $s);
        return $this->db->count_all_results();
    }
    ...
    function peso($c1, $c2) {
        $this->db->from('datosnino');
        $this->db->where('peso >=', $c1);
        $this->db->where('peso <=', $c2);
        return $this->db->count_all_results();
    }
    
    function talla($c1, $c2) {
        $this->db->from('datosnino');
        $this->db->where('talla >=', $c1);
        $this->db->where('talla <=', $c2);
        return $this->db->count_all_results();
    }
