...
class Cim_model extends CI_Model {
    ...
    public function ver_informe($id) {
        ...
        $this->db->where("distribucion.id", $id);
        $this->db->join('tipo_bien_inmueble', 'tipo_bien_inmueble.id = distribucion.tipo_bien_inmueble');
        $this->db->join('forma_procedimiento_distribucion', 'forma_procedimiento_distribucion.id = distribucion.forma_procedimiento_distribucion');
        $this->db->join('zona', 'zona.id = distribucion.zona');
        $this->db->from('distribucion');
