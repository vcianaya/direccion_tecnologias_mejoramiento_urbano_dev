    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="h4"> <a href="<?php echo base_url() ?>servicio_extraordinario/registros_servicio_extraordinario" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> /<strong style="color: #E13300">(EDITAR)</strong>  FORMULARIO DE SERVICIO EXTRAORDINARIO  </li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        <input type="hidden" id="id_servicio" value="<?= $e->id_servicio ?>" class="form-control" name="id_servicio" >
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group celfrm opt2">
                                ...
                                <select name="tipo_servicio_extraordinario" id="tipo_servicio_extraordinario" class="form-control" >
                                    <option value="<?= $e->tipo_servicio_extraordinario ?>"><?= $e->nombre_tipo_servicio_extraordinario ?></option>
