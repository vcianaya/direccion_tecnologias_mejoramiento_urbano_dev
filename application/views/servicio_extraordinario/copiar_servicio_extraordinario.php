    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="h4"> <a href="<?php echo base_url() ?>servicio_extraordinario/registros_servicio_extraordinario" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> /<strong style="color: #E13300">(COPIAR)</strong>  FORMULARIO DE SERVICIO EXTRAORDINARIO  </li>
            </ol>
        </section>
