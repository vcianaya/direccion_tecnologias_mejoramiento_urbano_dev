    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="h4"> <a href="<?php echo base_url() ?>faltas_contravenciones/registros_faltas_contravenciones" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> /<strong style="color: #E13300">(EDITAR)</strong>  FORMULARIO DE FALTAS Y CONTRAVENCIONES POLICIALES Y CONSUMO DE BEBIDAS ALCOHOLICAS (LEY 259) </li>
            </ol>
        </section>
        ...
        <!--------------Content--------------->
        <?php echo form_open('faltas_contravenciones/update_faltas_contravenciones'); ?>
        <?php
        foreach ($edit as $e):
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        <input type="hidden" id="id_faltas" value="<?= $e->id_faltas ?>" class="form-control" name="id_faltas" >
