...
$config = array();
$luminaria = $this->faltas_contravenciones_model->get_luminarias($id_luminaria);
foreach ($luminaria as $info_marker2) {
 $areas = $info_marker2->area;
}
 $postes = $this->faltas_contravenciones_model->get_areas2($areas);  

foreach ($postes as $info_marker) {
    $config['center'] = $info_marker->pos_y . ',' . $info_marker->pos_x;
}
$config['zoom'] = '22';
