...
$polygon2['strokeColor'] = '#000000';
$polygon2['strokeWeight'] = '6';
...
$polygon3['strokeColor'] = '#000000';
$polygon3['strokeWeight'] = '6';
...
$polygon4['strokeColor'] = '#000000';
$polygon4['strokeWeight'] = '6';
...
$polygon5['strokeColor'] = '#000000';
$polygon5['strokeWeight'] = '6';
...
$polygon6['strokeColor'] = '#000000';
$polygon6['strokeWeight'] = '6';
...
$polygon7['strokeColor'] = '#000000';
$polygon7['strokeWeight'] = '6';
...
$polygon8['strokeColor'] = '#000000';
$polygon8['strokeWeight'] = '6';
...
$polygon9['strokeColor'] = '#000000';
$polygon9['strokeWeight'] = '6';
...
$polygon10['strokeColor'] = '#000000';
$polygon10['strokeWeight'] = '6';
...
$polygon11['strokeColor'] = '#000000';
$polygon11['strokeWeight'] = '6';
...
$polygon12['strokeColor'] = '#000000';
$polygon12['strokeWeight'] = '6';
...
$polygon13['strokeColor'] = '#000000';
$polygon13['strokeWeight'] = '6';
...
$polygon14['strokeColor'] = '#000000';
$polygon14['strokeWeight'] = '6';
...
$postes = $this->faltas_contravenciones_model->get_areas();
foreach ($postes as $info_marker) {

    $tipo_icon = 'assets/logos/plazas_parques.png';
    $marker = array();
    $marker ['animation'] = 'DROP';
    $marker ['position'] = $info_marker->pos_y . ',' . $info_marker->pos_x;
    $marker['icon'] = base_url() . $tipo_icon;
    $marker ['infowindow_content'] = ' <strong> Codigo del area: </strong> ' . $info_marker->codigo_area.
            '<br> <strong> Nombre del area: </strong> ' . $info_marker->nombre_area.
            '<br> <strong> Tipo del area: </strong> ' . $info_marker->tipo_area.
            '<br> <strong> Distrito: </strong> ' . $info_marker->distrito.
            '<br> <strong> Direccion: </strong> ' . $info_marker->direccion.
            '<br> <strong> Nro de postes de luz: </strong> ' . $info_marker->nro_postes_luz.
            '<br> <strong> Nro de postes de luz no funcionan: </strong> ' . $info_marker->nro_no_funcionan.
            '<br> <strong>Estado del area de la plaza: </strong> ' . $info_marker->estado_area_plaza.
            '<br> <strong>Estado del equipamiento de la plaza: </strong> ' . $info_marker->equipamiento_area.
            '<br> <strong>Estado de la banqueta de la plaza: </strong> ' . $info_marker->banqueta_area.
            '<br> <strong>Estado del basurero de la plaza: </strong> ' . $info_marker->basureros.
            '<br> <strong>Estado del monumento de la plaza: </strong> ' . $info_marker->monumentos.
            '<br> <strong>Estado del mantenimiento de la plaza: </strong> ' . $info_marker->mantenimiento.
            '<br> <strong>Tiene modulo policial: </strong> ' . $info_marker->modulo_policial.
            '<br> <strong>Tiene centro salud : </strong> ' . $info_marker->centro_salud.
            '<br> <strong>Tiene parada de trasnporte : </strong> ' . $info_marker->parada_trasnporte.
            '<br> <strong>Tiene comercio : </strong> ' . $info_marker->comercio.
            '<br> <strong>Tiene venta comidas : </strong> ' . $info_marker->venta_comidas.
            '<br> <strong>Tiene snacks : </strong> ' . $info_marker->snacks.
            '<br> <strong>Tiene venta productos : </strong> ' . $info_marker->venta_productos;
