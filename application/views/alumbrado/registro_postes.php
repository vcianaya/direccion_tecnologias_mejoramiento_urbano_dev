    ...
    <![endif]-->
        ...
        <script type="text/javascript">
            function showCoords(newLat, newLng)
            {
                $('.long').html(newLat);
                $('.lati').html(newLng);
                $('input[name=pos_y_p]').val(newLat).attr('readonly', 'readonly');
                $('input[name=pos_x_p]').val(newLng).attr('readonly', 'readonly');
            }
        </script>
    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <table border="0">
                    <tr>
                        <td>  <li class="h4"> <a href="<?php echo base_url2() ?>editor/lista_modulos" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(REGISTRAR)</strong>  FORMULARIO DE PLAZAS Y PARQUES</li></td>
