...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li class="h4"> <a href="<?php echo base_url() ?>auxilios/registros_auxilios" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(EDITAR)</strong>  FORMULARIO DE AUXILIOS </li></td>
        ...
        <!--------------Content--------------->
        <?php echo form_open('auxilios/update_auxilios'); ?>
        <?php
        foreach ($edit as $e):
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        <input type="hidden" id="id_auxilios" value="<?= $e->id_auxilios ?>" class="form-control" name="id_auxilios" >
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            <label for="curpwd">Nombre Auxiliador </label>
                            <input type="text" id="nombre_auxiliador" class="form-control" name="nombre_auxiliador" placeholder="Nombre Auxiliador" value="<?= $e->nombre_auxiliador ?>">
                        </div>
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="nacionalidad" id="nacionalidad" class="form-control" >
                                <option value="<?= $e->nacionalidad ?>"><?= $e->nombre_nacionalidad ?></option>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="edad" class="form-control" name="edad" placeholder="Edad  " value="<?= $e->edad ?>">
                        </div>


                        <div class="form-group celfrm opt2">
                            <label for="curpwd" >Sexo : </label>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            <label for="curpwd">Personas capacidades diferentes </label>
                            <input type="text" id="personas_capacidades_diferentes" class="form-control" name="personas_capacidades_diferentes" placeholder="Personas capacidades diferentes " value="<?= $e->personas_capacidades_diferentes ?>">
                        </div>


                        <div class="form-group celfrm opt2">
                            <label for="curpwd" >Diferentes auxilios: </label>
                            <select name="diferentes_auxilios" id="diferentes_auxilios" class="form-control" >
                                <option value="<?= $e->diferentes_auxilios ?>"><?= $e->nombre_diferentes_auxilios ?></option>
                                <?php foreach ($diferentes_auxilios as $i) { ?>
                                    <option value="<?= $i->id ?>"><?= $i->nombre_diferentes_auxilios ?></option>
                                <?php } ?>	
                            </select>
                        </div>
                        ...
                        <div class="box-footer">
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('auxilios/registros_auxilios'); ?>
