...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li class="h4"> <a href="<?php echo base_url() ?>auxilios/registros_auxilios" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(COPIAR)</strong>  FORMULARIO DE AUXILIOS </li></td>
        ...
        <!--------------Content--------------->
        <?php echo form_open('auxilios/guardar_auxilios'); ?>
        <?php
        foreach ($edit as $e):
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                          <?php
                        $rs = mysql_query("SELECT MAX(id_auxilios) AS id FROM auxilios");
