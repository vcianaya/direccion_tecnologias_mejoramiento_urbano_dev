                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="nombre_auxiliador" class="form-control" name="nombre_auxiliador" placeholder="Nombre Auxiliador">
                        </div>
                        ...
                        <div class="form-group celfrm opt2">
                            <label for="curpwd" >Nacionalidad : </label>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="personas_capacidades_diferentes" class="form-control" name="personas_capacidades_diferentes" placeholder="Personas capacidades diferentes ">
                        </div>
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="diferentes_auxilios" id="diferentes_auxilios" class="form-control" >
                                <option value="">Seleccione Auxilio</option>
