        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="h4"> <a href="javascript:history.back(1)" style="color: #337ab7">
                        <i class="fa fa-arrow-left"></i> Volver </a> / REPORTE DE FELCC (GENERAL) </li>
                            ...
                            <?php } else {
                                ...
                                <div id="Layer1" style="width:420px; height:240px; overflow: scroll;">
                                    ...
                                    foreach ($datos as $marker_sidebar) {
                                        ...
                                        <li onClick="datos_marker(<?= $marker_sidebar->pos_y ?>,<?= $marker_sidebar->pos_x ?>, marker_<?= $marker_sidebar->id_felcc ?>)">
                                            <?= '<strong style="color: #c7254e">✓&nbsp;&nbsp;Delito:</strong>  ' . $marker_sidebar->nombre_division . '<br/> <strong style="color: #c7254e">✓&nbsp;&nbsp;Calle / Avenida:</strong> ' . $marker_sidebar->zona_barrio . '<br/> <strong style="color: #c7254e">✓&nbsp;&nbsp;Fecha del Hecho:</strong>  ' . $marker_sidebar->fecha_hecho ?></li>
                                        <?php
                                    }
                                }
                                ?>
