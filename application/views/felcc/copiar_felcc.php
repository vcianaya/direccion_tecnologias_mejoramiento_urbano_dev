    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="h4"> <a href="<?php echo base_url() ?>editor/lista_modulos" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(REGISTRAR)</strong>  FORMULARIO DE FELCC (DELITOS  ATENDIDOS  POR  LA  POLICIA  BOLIVIANA)</li>
            </ol>
        </section>
        ...
        <!--------------Content--------------->
        <?php echo form_open('felcc/guardar_felcc'); ?>
        <?php
        foreach ($edit as $e):
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        <?php
                        $rs = mysql_query("SELECT MAX(id_felcc) AS id FROM felcc");
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="numero_formulario" class="form-control" name="numero_formulario"  readonly="true" placeholder="Nro de Formulario"  value="<?= $total ?>" >
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="arrestado" id="arrestado" class="form-control" >
                                <option value="<?= $e->arrestado ?>"><?= $e->arrestado ?> </option>
