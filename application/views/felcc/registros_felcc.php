    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <table border="0">
                    <tr>
                        <td>  <li class="h4"> <a href="<?php echo base_url() ?>editor/lista_modulos" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(REGISTRAR)</strong>  FORMULARIO DE FELCC (DELITOS  ATENDIDOS  POR  LA  POLICIA  BOLIVIANA)</li></td>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="n_registro" class="form-control" name="n_registro" placeholder="Numero Registro  ">
                        </div>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="nombre_victima" class="form-control" name="nombre_victima" placeholder="Nombre de la Victima ">
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">Edad de la Victima </label>
                            <input type="text" id="edad_victima" class="form-control" name="edad_victima" placeholder="Edad de la Victima ">
                        </div>
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="estado_civil_victima" id="estado_civil_victima" class="form-control" >
                                <option value="">Seleccione el Estado Civil de la Victima</option>
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="ocupacion_victima" id="ocupacion_victima" class="form-control" >
                                <option value="">Seleccione la Ocupacion de la Victima</option>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="domicilio_victima" class="form-control" name="domicilio_victima" placeholder="Domicilio Victima">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="nombre_denunciado" class="form-control" name="nombre_denunciado" placeholder="Nombre del Denunciado">
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">Nombre del Complice  </label>
                            <input type="text" id="nombre_complices" class="form-control" name="nombre_complices" placeholder="Nombre del Complice">
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">Edad del Denunciado  </label>
                            <input type="text" id="edad_denunciado" class="form-control" name="edad_denunciado" placeholder="Edad del Denunciado ">
                        </div>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="ci_denunciado" class="form-control" name="ci_denunciado" placeholder="CI del Denunciado  ">
                        </div>
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="estado_civil_denunciado" id="estado_civil_denunciado" class="form-control" >
                                <option value="">Seleccione el Estado Civil del Denunciado</option>
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="ocupacion_denunciado" id="ocupacion_denunciado" class="form-control" >
                                <option value="">Seleccione la Ocupacion del Denunciado</option>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="domicilio_denunciado" class="form-control" name="domicilio_denunciado" placeholder="Domicilio Denunciado">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="alias" class="form-control" name="alias" placeholder="Alias ">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="lugar_especifico" class="form-control" name="lugar_especifico" placeholder="Lugar Especifico   ">
                        </div>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group supfrm">
                                ...
                                <input type="text" id="causas_hecho" class="form-control" name="causas_hecho" placeholder="Causas del Hecho   ">
                            </div>

                            <div class="form-group supfrm">
                                <label for="curpwd">Objetos Robados </label>
                                <input type="text" id="objetos_robados" class="form-control" name="objetos_robados" placeholder="Objetos Robados">
                            </div>

                            <div class="form-group supfrm">
                                <label for="curpwd">Medios Utilizados</label>
                                <input type="text" id="medios_utilizados" class="form-control" name="medios_utilizados" placeholder="Medios Utilizados">
                            </div>

                            <div class="form-group supfrm">
                                <label for="curpwd">Instrumento Utilizados</label>
                                <input type="text" id="instrumento_utilizado" class="form-control" name="instrumento_utilizado" placeholder="Instrumento Utilizados">
                            </div>

                            <div class="form-group supfrm">
                                <label for="curpwd">Numero de Caso  </label>
                                <input type="text" id="caso_n" class="form-control" name="caso_n" placeholder="Numero de Caso ">
                            </div>

                            <div class="form-group supfrm">
                                <label for="curpwd">Asignado</label>
                                <input type="text" id="asignado" class="form-control" name="asignado" placeholder="Asignado">
                            </div>

                            <div class="form-group celfrm opt2">
                                <label for="curpwd" >Estado del caso: </label>
                                <select name="estado_caso" id="estado_caso" class="form-control" >
                                    <option value="">Seleccione el estado de caso </option>
                            ...
                            <div class="form-group supfrm">
                                ...
                                <textarea class="form-control" rows="3" name="detalle_caso" id="detalle_caso" placeholder="Detalle Caso" ></textarea>
                            </div>
                            ...
                            <div class='errorbox-good'>
                                <div class='ss-item ss-item-required ss-text'>
                                    <div class='ss-form-entry'>
                                        ...
                                        <input type='text' name='pos_y' value=''  id='pos_y' placeholder='click en el Mapa'  />
                                    </div>
                                </div>
                            </div>
                            <br/>
                            <div class='errorbox-good'>
                                <div class='ss-item ss-item-required ss-text'>
                                    <div class='ss-form-entry'>
                                        ...
                                        <input type='text' name='pos_x' value='' id='pos_x' placeholder='click en el Mapa' />
                                    </div>
                                </div>
                            </div>
