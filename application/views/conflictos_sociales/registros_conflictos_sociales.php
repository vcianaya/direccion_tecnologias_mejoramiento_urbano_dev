    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <table border="0">
                    <tr>
                        <td>  <li class="h4"> <a href="<?php echo base_url() ?>editor/lista_modulos" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(REGISTRAR)</strong>  FORMULARIO DE CONFLICTOS SOCIALES </li></td>
        ...
        <!--------------Content--------------->
        <?php echo form_open('conflictos_sociales/guardar_conflictos_sociales'); ?>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="number" id="cod_num" class="form-control" name="cod_num" placeholder="Codigo Numero" required>
                        </div>
                        ...
                        <div class="form-group supfrm">
                            <label for="curpwd">Fecha del Conflicto: <span class='ss-required-asterisk'>*</span></label>
                            <input type="date" id="fecha_hecho" class="form-control" name="fecha_hecho" placeholder="Fecha del Conflicto " required>
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">Hora del Conflicto: <span class='ss-required-asterisk'>*</span></label>
                            <input type="time" id="hora_hecho" class="form-control" name="hora_hecho" placeholder="Hora del Conflicto" required>
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="tipo_conflictos" id="tipo_conflictos" class="form-control" >
                                <option value="">Seleccione el Conflicto</option>
                            ...
                            <div class='errorbox-good'>
                                <div class='ss-item ss-item-required ss-text'>
                                    <div class='ss-form-entry'>
                                        ...
                                        <input type='text' name='pos_y' value=''  id='pos_y' placeholder='click en el Mapa' readonly />
                                    </div>
                                </div>
                            </div>
                            <br/>
                            <div class='errorbox-good'>
                                <div class='ss-item ss-item-required ss-text'>
                                    <div class='ss-form-entry'>
                                        ...
                                        <input type='text' name='pos_x' value='' id='pos_x' placeholder='click en el Mapa' readonly />
                                    </div>
                                </div>
                            </div>
