    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="h4"> <a href="<?php echo base_url() ?>conflictos_sociales/registros_conflictos_sociales" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> /<strong style="color: #E13300">(EDITAR)</strong>  FORMULARIO DE CONFLICTOS SOCIALES </li>
            </ol>
        </section>
        ...
        <!--------------Content--------------->
        <?php echo form_open('servicio_extraordinario/update_servicio_extraordinario'); ?>
        <?php
        foreach ($edit as $e):
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        <input type="hidden" id="id_conflicto" value="<?= $e->id_conflicto ?>" class="form-control" name="id_conflicto" >
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group celfrm opt2">
                          ...
                          <div class="form-group celfrm opt2">
                                 <label for="curpwd" >Tipo de Conflicto: </label>
                            <select name="tipo_conflictos" id="tipo_conflictos" class="form-control" >
                                    <option value="<?= $e->tipo_conflictos ?>"><?= $e->nombre_tipo_conflictos ?></option>
                                    <?php foreach ($tipo_conflictos as $i) { ?>
                                        <option value="<?= $i->id ?>"><?= $i->nombre_tipo_conflictos ?></option>
                                    <?php } ?>	
                                </select>
                            </div>
                        
                          <div class="form-group celfrm opt2">
                                <label for="curpwd" >Sectores y/o grupos movilizados: </label>
                            <select name="sectores_grupos_movilizados" id="sectores_grupos_movilizados" class="form-control" >
                                    <option value="<?= $e->sectores_grupos_movilizados ?>"><?= $e->nombre_sectores_grupos_movilizados ?></option>
                                    <?php foreach ($sectores_grupos_movilizados as $i) { ?>
                                        <option value="<?= $i->id ?>"><?= $i->nombre_sectores_grupos_movilizados ?></option>
                                    <?php } ?>	
                                </select>
                            </div>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                             ...
                             <div class="form-group supfrm">
                                ...
                                <input type="number" id="num_evento" class="form-control" name="num_evento" placeholder="Numero de evento y/o Actividad " value="<?= $e->num_evento ?>">
                            </div>

                            <div class="form-group celfrm opt2">
                              <label for="curpwd" >resguardos e intervenciones: </label>
                                <select name="resguardos_intervenciones" id="resguardos_intervenciones" class="form-control" >
                                    <option value="<?= $e->resguardos_intervenciones ?>"><?= $e->nombre_resguardos_intervenciones ?></option>
                                    <?php foreach ($resguardos_intervenciones as $i) { ?>
                                        <option value="<?= $i->id ?>"><?= $i->nombre_resguardos_intervenciones ?></option>
                                    <?php } ?>	
                                </select>
                            </div>
                            ...
                            <div class="form-group supfrm">
                                ...
                                <input type="number" id="num_grupos_desplegados" class="form-control" name="num_grupos_desplegados" placeholder="Numero de Grupos Desplegados" value="<?= $e->num_grupos_desplegados ?>">
                            </div>
                        ...
                        <div class="box-footer">
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('servicio_extraordinario/registros_servicio_extraordinario'); ?>
