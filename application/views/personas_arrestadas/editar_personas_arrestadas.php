...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li class="h4"> <a href="<?php echo base_url() ?>ersonas_arrestadas/registros_personas_arrestadas" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(EDITAR)</strong>  FORMULARIO DE PERSONAS ARRESTADAS </li></td>
        ...
        <!--------------Content--------------->
        <?php echo form_open('personas_arrestadas/update_personas_arrestadas'); ?>
        <?php
        foreach ($edit as $e):
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        <input type="hidden" id="id_arrestadas" value="<?= $e->id_arrestadas ?>" class="form-control" name="id_arrestadas" >
                        <div class="form-group supfrm">
                            <label for="curpwd">Nro de Formulario:</label>
                            <input type="number" id="numero_formulario" value="<?= $e->numero_formulario ?>"  readonly="true"  class="form-control" name="numero_formulario" placeholder="Nro de Formulario">
                        </div>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            <label for="curpwd">Lugar Hecho Avenida / Calle <span class='ss-required-asterisk'>*</span></label>
                        ...
                        <div class="form-group supfrm">
                            <label for="curpwd">Nombre Arrestado</label>
                            <input type="text" id="nombre_arrestado" class="form-control" name="nombre_arrestado" placeholder="Nombre Arrestado" value="<?= $e->nombre_arrestado ?>">
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">CI   </label>
                            <input type="text" id="ci" class="form-control" name="ci" placeholder="CI " value="<?= $e->ci ?>">
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">Nacido   </label>
                            <input type="text" id="nacido_en" class="form-control" name="nacido_en" placeholder="Nacido  "  value="<?= $e->nacido_en ?>">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            <label for="curpwd">Telefono de Referencia</label>
                            <input type="text" id="telefono_referencia" class="form-control" name="telefono_referencia" placeholder="Telefono de Referencia " value="<?= $e->telefono_referencia ?>">
                        </div>


                        <div class="form-group celfrm opt2">
                            <label for="curpwd" >Temperancia : </label>
                            <select name="temperancia" id="temperancia" class="form-control" >
                                <option value="<?= $e->temperancia ?>"><?= $e->nombre_temperancia ?></option>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            <label for="curpwd">Causas del Arresto </label>
                            <input type="text" id="causas_arresto" class="form-control" name="causas_arresto" placeholder="Causas del Arresto" value="<?= $e->causas_arresto ?>">
                        </div>


                        <div class="form-group celfrm opt2">
                            <label for="curpwd" >Naturaleza Hecho: </label>
                            <select name="naturaleza_hecho" id="naturaleza_hecho" class="form-control" >
                                <option value="<?= $e->naturaleza_hecho ?>"><?= $e->nombre_naturaleza_hecho ?> </option>
                                <?php foreach ($naturaleza_hecho as $i) { ?>
                                    <option value="<?= $i->id ?>"><?= $i->nombre_naturaleza_hecho ?></option>
                                <?php } ?>	
                            </select>
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">Arma o Instrumento utilizado </label>
                            <input type="text" id="arma_instrumento" class="form-control" name="arma_instrumento" placeholder="Arma o Instrumento utilizado" value="<?= $e->arma_instrumento ?>">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            <label for="curpwd">Nombre Policia  </label>
                            <input type="text" id="nombre_policia" class="form-control" name="nombre_policia" placeholder="Nombre Policia "  value="<?= $e->nombre_policia ?>">
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">Pertenencias del Arrestado  </label>
                            <input type="text" id="pertenencias_arrestado" class="form-control" name="pertenencias_arrestado" placeholder="Pertenencias del Arrestado " value="<?= $e->pertenencias_arrestado ?>">
                        </div>
                        ...
                        <div class="box-footer">
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('personas_arrestadas/registros_personas_arrestadas'); ?>
