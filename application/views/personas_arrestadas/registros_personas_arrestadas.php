    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <table border="0">
                    <tr>
                        <td>  <li class="h4"> <a href="<?php echo base_url() ?>editor/lista_modulos" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(REGISTRAR)</strong>  FORMULARIO DE AUXILIOS </li></td>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="nombre_arrestado" class="form-control" name="nombre_arrestado" placeholder="Nombre Arrestado">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="nacido_en" class="form-control" name="nacido_en" placeholder="Nacido  ">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="telefono_referencia" class="form-control" name="telefono_referencia" placeholder="Telefono de Referencia ">
                        </div>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="causas_arresto" class="form-control" name="causas_arresto" placeholder="Causas del Arresto">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="arma_instrumento" class="form-control" name="arma_instrumento" placeholder="Arma o Instrumento utilizado">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="nombre_policia" class="form-control" name="nombre_policia" placeholder="Nombre Policia ">
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">Pertenencias del Arrestado  </label>
                            <input type="text" id="pertenencias_arrestado" class="form-control" name="pertenencias_arrestado" placeholder="Pertenencias del Arrestado ">
                        </div>
