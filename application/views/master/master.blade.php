...
<!-- favicon -->
<link rel="shortcut icon" href="<?= base_url() ?>assets/master/images/favicon.ico" type="image/x-icon">
<link rel="icon" href="<?= base_url() ?>assets/master/images/favicon.ico" type="image/x-icon">
					...
					<div class="container">
						...
						<div class="navbar-collapse  collapse">
							<ul class="nav navbar-nav navbar-right scroll">
								 <li class="active"><a href="#works"><?= $this->session->userdata('username') ?></a></li>
							</ul>
						</div>
						<!-- #Nav Ends -->
					</div>
