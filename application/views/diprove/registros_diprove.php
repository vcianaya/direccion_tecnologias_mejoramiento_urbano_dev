    ...
    <body>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <table border="0">
                    <tr>
                        <td>  <li class="h4"> <a href="<?php echo base_url() ?>editor/lista_modulos" style="color: #337ab7"><i class="fa fa-arrow-left "></i> Volver </a> / <strong style="color: #E13300">(REGISTRAR)</strong>  FFORMULARIO DE DIPROVE (DELITOS  ATENDIDOS  POR  LA  POLICIA  BOLIVIANA) </li></td>
                    <td> <?php echo form_open('diprove/excel_diprove'); ?>

                        <button type="submit" class="btn btn-success" >Exportar  Diprove</button>                            
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="denuncia" id="denuncia" class="form-control" >
                                <option value="">Seleccione la Denuncia</option>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="telefono_victima" class="form-control" name="telefono_victima" placeholder="Telefono de la Victima ">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <textarea class="form-control" rows="3" name="descripcion_falta" id="descripcion_falta" placeholder="Descripcion de la falta" required="true"></textarea>
                        </div>
                ...
                <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="nombre_infractor" class="form-control" name="nombre_infractor" placeholder="Nombre del Infractor  ">
                        </div>

                        <div class="form-group supfrm">
                            <label for="curpwd">CI del Infractor  </label>
                            <input type="text" id="ci_infractor" class="form-control" name="ci_infractor" placeholder="CI del Infractor  ">
                        </div>
                        ...
                        <div class="form-group celfrm opt2">
                            ...
                            <select name="categoria_licencia" id="categoria_licencia" class="form-control" >
                                <option value="">Seleccione la Categoria de la licencia</option>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="edad_infractor" class="form-control" name="edad_infractor" placeholder="Edad del Infractor ">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="telefono_infractor" class="form-control" name="telefono_infractor" placeholder="Telefono del Infractor ">
                        </div>
                        ...
                        <div class="form-group supfrm">
                            ...
                            <input type="text" id="placa" class="form-control" name="placa" placeholder="Placa ">
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group celfrm opt2">
                                ...
                                <select name="sancion" id="sancion" class="form-control" >
                                    <option value="">Seleccione la sancion </option>
                            ...
                            <div class="form-group celfrm opt2">
                                ...
                                <select name="termino_prueba" id="termino_prueba" class="form-control" >
                                    <option value="">Seleccione el termino prueba </option>
                            ...
                            <div class="form-group supfrm">
                                ...
                                <input type="text" id="numero_caso" class="form-control" name="numero_caso" placeholder="Numero de Caso ">
                            </div>

                            <div class="form-group supfrm">
                                <label for="curpwd">Arma Utilizada  </label>
                                <input type="text" id="arma_utilizada" class="form-control" name="arma_utilizada" placeholder="Arma Utilizada">
                            </div>
                        ...
                        <tr>
                            <td colspan="2" ><table  border="2" align="center">
                                    <tr class="fondo">
                                        ...
                                        <td rowspan="2" class="negrita">Codigo Numero</td>
                                        <td rowspan="2" class="negrita">Fecha Hecho </td>
                                        <td rowspan="2" class="negrita">Hora Hecho</td>
                                        <td rowspan="2" class="negrita">Mes</td>

                                        <td rowspan="2" class="negrita">Lugar del Hecho</td>
                                        <td rowspan="2" class="negrita">Nombre de la EPI</td>
                                        <td rowspan="2" class="negrita">Denuncia</td>

                                        <td rowspan="2" class="negrita">Descripcion de la falta</td>
                                        <td rowspan="2" class="negrita">Eliminar Registro </td>
                                        <td rowspan="2" class="negrita">Editar Registro </td>
                                        <td rowspan="2" class="negrita">Aprobar Registro</td>
                                        <td rowspan="2" class="negrita">Copiar Registro</td>
                                    ...
                                    foreach ($faltas_contravenciones as $fila) {
                                        ?>
                                        <tr>
                                            <td ><strong><?= $fila->numero_formulario ?>  </strong></td>
                                            <td><?= $fila->cod_num ?></td>
                                            <td><?= $fila->fecha_hecho ?></td>
                                            <td><?= $fila->hora_hecho ?></td>
                                            <td><?= $fila->nombre_mes ?></td>
                                            <td><?= $fila->lugar_hecho ?></td>
                                            <td><?= $fila->nombre_epis ?></td>
                                            <td><?= $fila->nombre_denuncia ?></td>

                                            <td> <?= $fila->descripcion_falta ?></td>
                                            <td align="center"><a onClick="if (confirma() == false)
                                                        return false" href="<?= base_url() ?>faltas_contravenciones/borrar_faltas_contravenciones/<?= $fila->id_faltas ?>">
                                                    <img type="image" src="<?= base_url() ?>/assets/img/eliminar.png" height="45px" title="Eliminar Registro" >
                                                </a></td>
                                            <td align="center">
                                                <a  href="<?= base_url() ?>faltas_contravenciones/edicion_faltas_contravenciones/<?= $fila->id_faltas ?>">
                                                    <img type="image" src="<?= base_url() ?>/assets/img/editar.png" height="45px" title="Eliminar Registro" >
                                                </a>
                                            </td>
                                            <td align="center"><a onClick="if (confirma_aprobar() == false)
                                                        return false" href="<?= base_url() ?>faltas_contravenciones/aprobar_faltas_contravenciones/<?= $fila->id_faltas ?>">
                                                    <img type="image" src="<?= base_url() ?>/assets/img/activado3.png" height="50px" title="Aprobar Formulario">
                                                </a></td>
                                            <td align="center">
                                                <a  href="<?= base_url() ?>faltas_contravenciones/copiar_faltas_contravenciones/<?= $fila->id_faltas ?>">
