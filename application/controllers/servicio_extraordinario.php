 ...
 * 
 */
class Servicio_extraordinario extends CI_Controller {
...
//    $this->load->view('footer');
    ...
    function eliminar($value, $row) {
        ...
        $data = $this->db->get_where('servicio_extraordinario', array('servicio_extraordinario.id_servicio' => $row->id_servicio))->row();
        return '<a onClick="if (confirma() == false)
                            return false" href="' . base_url() . 'servicio_extraordinario/borrar_servicio_extraordinario/' . $row->id_servicio . '">
    ...
    function editar($value, $row) {
        $this->db->select('*'); //seleccionamos el id y todo de employer
        $data = $this->db->get_where('servicio_extraordinario', array('servicio_extraordinario.id_servicio' => $row->id_servicio))->row();
        return '<a  href="' . base_url() . 'servicio_extraordinario/edicion_servicio_extraordinario/' . $row->id_servicio . '">
    ...
    function aprobar($value, $row) {
        ...
        return '<a onClick="if (confirma_aprobar() == false)
                                                                return false" href="' . base_url() . 'servicio_extraordinario/aprobar_servicio_extraordinario/' . $row->id_servicio . '">
    ...
    function copiar($value, $row) {
        $this->db->select('*'); //seleccionamos el id y todo de employer
        $data = $this->db->get_where('servicio_extraordinario', array('servicio_extraordinario.id_servicio' => $row->id_servicio))->row();
        return ' <a  href="' . base_url() . 'servicio_extraordinario/copiar_servicio_extraordinario/' . $row->id_servicio . '">
                                                    <img type="image" src="' . base_url() . '/assets/img/copiar.png" height="50px" title="Copiar Formulario">
                                                </a>';
    }

    public function registros_servicio_extraordinario() {
        $usuario = $this->session->userdata('id_usuario');
        $crud = new grocery_CRUD();
// $crud->set_theme('datatables');
        $crud->set_table('servicio_extraordinario');
        $crud->set_subject('servicio_extraordinario');
//$crud->set_table('defensoria_na');
        //  $crud->where('id_usuario', $usuario);
        $crud->where('estado_aprobacion', 0);
        $crud->columns(
                'Eliminar Registro', 'Editar Registro', 'Aprobar Registro', 'Copiar Registro', 'id_servicio', 'numero_formulario', 'cod_num', 'gestion', 'fecha_hecho', 'hora_hecho', 'mes', 'departamento', 'provincia', 'municipio', 'localidad', 'distrito', 'zona', 'lugar_hecho', 'pos_x', 'pos_y', 'epis', 'tipo_servicio_extraordinario', 'num_evento', 'num_grupos_desplegados', 'remision_caso', 'servicio_destacado');
        ...
        $crud->set_relation('tipo_servicio_extraordinario', 'tipo_servicio_extraordinario', 'nombre_tipo_servicio_extraordinario');
        ...
        $data = array(
            "provincias" => $this->servicio_extraordinario_model->getProvincias(),
            "gestion" => $this->servicio_extraordinario_model->gestion(),
            "mes" => $this->servicio_extraordinario_model->mes(),
            "departamento" => $this->servicio_extraordinario_model->departamento(),
            "provincia" => $this->servicio_extraordinario_model->provincia(),
            "municipio" => $this->servicio_extraordinario_model->municipio(),
            "localidad" => $this->servicio_extraordinario_model->localidad(),
            "epis" => $this->servicio_extraordinario_model->epis(),
            "nacionalidad" => $this->servicio_extraordinario_model->nacionalidad(),
            "tipo_servicio_extraordinario" => $this->servicio_extraordinario_model->tipo_servicio_extraordinario(),
            "genero" => $this->servicio_extraordinario_model->genero(),
            "temperancia" => $this->servicio_extraordinario_model->temperancia(),
            "categoria_licencia" => $this->servicio_extraordinario_model->categoria_licencia(),
            "tipo_vehiculo" => $this->servicio_extraordinario_model->tipo_vehiculo(),
            "servicio" => $this->servicio_extraordinario_model->servicio(),
            "arrestado" => $this->servicio_extraordinario_model->arrestado(),
            "sancion" => $this->servicio_extraordinario_model->sancion(),
            "estado_caso" => $this->servicio_extraordinario_model->estado_caso(),
            "remision_caso" => $this->servicio_extraordinario_model->remision_caso(),
            "termino_prueba" => $this->servicio_extraordinario_model->termino_prueba(),
            "recurso_apelacion" => $this->servicio_extraordinario_model->recurso_apelacion(),
            "servicio_destacado" => $this->servicio_extraordinario_model->servicio_destacado(),
...
// $data["solicitud_compra"] = $this->observatorio_model->lista_operativos();
        ...
        $this->load->view('servicio_extraordinario/registros_servicio_extraordinario', $data);
    }

    public function guardar_servicio_extraordinario() {


        $date = strtotime($this->input->post('fecha_hecho'));
        $dia = date("w", $date);

        $guardar_servicio_extraordinario = array(
            ...
            'tipo_servicio_extraordinario' => $this->input->post('tipo_servicio_extraordinario'),
...
//  $id_distrito = $this->input->post('provincias');
        ...
        $this->servicio_extraordinario_model->guardar_servicio_extraordinario($guardar_servicio_extraordinario);

        redirect(base_url() . 'servicio_extraordinario/registros_servicio_extraordinario');
    }

    public function update_servicio_extraordinario() {
...
//  $id_distrito = $this->input->post('provincias');
        ...
        $this->servicio_extraordinario_model->update_servicio_extraordinario($guardar_servicio_extraordinario, $id_servicio);

        redirect(base_url() . 'servicio_extraordinario/registros_servicio_extraordinario');
    }

    public function edicion_servicio_extraordinario() {
          $data = array(
            "provincias" => $this->servicio_extraordinario_model->getProvincias(),
            "gestion" => $this->servicio_extraordinario_model->gestion(),
            "mes" => $this->servicio_extraordinario_model->mes(),
        ...
        $edit = $this->servicio_extraordinario_model->servicio_extraordinario_edit($id_servicio);
        foreach ($edit as $e):
//$e->pos_x;
        endforeach;


        $this->load->view('distritos/distritos_edit_servicio_extraordinario', $edit);
...
//tendremos disponible en la vista mapa_view con el array data
        ...
        $data['datos'] = $this->mapa_model->get_markers_general_monitoreo_ubicacion();
        $data['edit'] = $this->servicio_extraordinario_model->servicio_extraordinario_edit($id_servicio);
        $data['map'] = $this->googlemaps->create_map();
...
// $data["solicitud_compra"] = $this->observatorio_model->lista_operativos();
        $data['titulo'] = 'Bienvenido de nuevo ' . $this->session->userdata('perfil');
        $this->load->view('header');
        $this->load->view('servicio_extraordinario/editar_servicio_extraordinario', $data);
    }

    public function copiar_servicio_extraordinario() {
            $data = array(
            "provincias" => $this->servicio_extraordinario_model->getProvincias(),
            "gestion" => $this->servicio_extraordinario_model->gestion(),
            "mes" => $this->servicio_extraordinario_model->mes(),
...
// $data["solicitud_compra"] = $this->observatorio_model->lista_operativos();
        $data['titulo'] = 'Bienvenido de nuevo ' . $this->session->userdata('perfil');
        $this->load->view('header');
        $this->load->view('servicio_extraordinario/copiar_servicio_extraordinario', $data);
    }
