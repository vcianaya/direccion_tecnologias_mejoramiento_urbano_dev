...
//    $this->load->view('footer');
    ...
    public function registro_dna() {

        $crud = new grocery_CRUD();
        $crud->set_table('defensoria');
        $crud->columns('Editar DNA','Imprimir Informe DNA', 'Agregar Caso Nuevo o de Seguimiento', 'Descripcion del Caso Nuevo o de Seguimiento', 'codigo_dna', 'fecha', 'nro_atencion', 'tipologia_principal', 'tipologia_secundaria', 'distrito', 'zona', 'domicilio', 'procedencia', 'telefono', 'domicilio2', 'telefono2',  'nombre_apellidos_1', 'nombre_apellidos_2', 'nombre_apellidos_3', 'nombre_apellidos_4', 'gestante_1', 'gestante_2', 'gestante_3', 'edada1', 'edada2', 'edada3', 'edada4', 'sexo1', 'sexo2', 'sexo3', 'sexo4', 'c_na1', 'c_na2', 'c_na3', 'c_na4', 'estudia1', 'estudia2', 'estudia3', 'estudia4', 'grado_instruccion_1', 'grado_instruccion_2', 'grado_instruccion_3', 'grado_instruccion_4', 'tipo_trabajo_1', 'tipo_trabajo_2', 'tipo_trabajo_3', 'tipo_trabajo_4', 'fam_nombre_apellidos_1', 'fam_nombre_apellidos_2', 'fam_nombre_apellidos_3', 'fam_nombre_apellidos_4', 'parentesco_1', 'parentesco_2', 'parentesco_3', 'parentesco_4', 'fam_edad_1', 'fam_edad_2', 'fam_edad_3', 'fam_edad_4', 'fam_sexo1', 'fam_sexo2', 'fam_sexo3', 'fam_sexo4', 'fam_grado_instruccion_1', 'fam_grado_instruccion_2', 'fam_grado_instruccion_3', 'fam_grado_instruccion_4', 'fam_ocupacion_1', 'fam_ocupacion_2', 'fam_ocupacion_3', 'fam_ocupacion_4', 'anonimo', 'denunciante_nombre', 'denunciante_ci', 'denunciante_domicilio', 'denunciante_lugar_trabajo', 'denunciante_telefono', 'denunciante_parentesco', 'denunciante_ocupacion', 'se_desconoce', 'denunciado_nombre', 'denunciado_edad', 'denunciado_sexo', 'denunciado_domicilio', 'denunciado_lugar_trabajo', 'denunciado_telefono', 'denunciado_parentesco', 'denunciado_ocupacion', 'denuncias_anteriores', 'anteriormente', 'descripcion', 'opinion', 'acciones');

        $crud->set_relation('distrito', 'distrito', 'nombre_distrito');
        $crud->set_relation('zona', 'zona', 'nombre_zona');
        $crud->set_relation('tipologia_principal', 'tipologia_primaria', 'nombre_tipologia_primaria');
        $crud->set_relation('tipologia_secundaria', 'tipologia_secundaria', 'nombre_tipologia_secundaria');
        $crud->callback_column('Imprimir Informe DNA', array($this, 'ver_nforme'));
        $crud->callback_column('Agregar Caso Nuevo o de Seguimiento', array($this, 'seguimiento'));
        $crud->callback_column('Descripcion del Caso Nuevo o de Seguimiento', array($this, 'descripcion_seguimiento'));
        ...
        $crud->unset_read();
        $crud->unset_print();
        $crud->set_subject('defensoria');
        $output = $crud->render();
        $this->_example_output($output);

        $data = array(
            "provincias" => $this->cim_model->getProvincias(),
            "tipologia_principal" => $this->cim_model->tipologia_principal()
        );
...
// $data["solicitud_compra"] = $this->observatorio_model->lista_operativos();
        ...
        $this->load->view('defensorias/registro_defensorias', $data);
    }
