 ...
 * 
 */
class Conflictos_sociales extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('servicio_extraordinario_model');
        $this->load->model('faltas_contravenciones_model');
        $this->load->model('conflictos_sociales_model');
...
//    $this->load->view('footer');
    ...
    function eliminar($value, $row) {
        ...
        $data = $this->db->get_where('conflictos_sociales', array('conflictos_sociales.id_conflicto' => $row->id_conflicto))->row();
        return '<a onClick="if (confirma() == false)
                            return false" href="' . base_url() . 'conflictos_sociales/borrar_conflictos_socialeso/' . $row->id_conflicto . '">
    ...
    function editar($value, $row) {
        $this->db->select('*'); //seleccionamos el id y todo de employer
        $data = $this->db->get_where('conflictos_sociales', array('conflictos_sociales.id_conflicto' => $row->id_conflicto))->row();
        return '<a  href="' . base_url() . 'conflictos_sociales/edicion_conflictos_sociales/' . $row->id_conflicto . '">
    ...
    function aprobar($value, $row) {
        ...
        return '<a onClick="if (confirma_aprobar() == false)
                                                                return false" href="' . base_url() . 'conflictos_sociales/aprobar_conflictos_sociales/' . $row->id_conflicto . '">
    ...
    function copiar($value, $row) {
        $this->db->select('*'); //seleccionamos el id y todo de employer
        $data = $this->db->get_where('conflictos_sociales', array('conflictos_sociales.id_conflicto' => $row->id_conflicto))->row();
        return ' <a  href="' . base_url() . 'conflictos_sociales/copiar_conflictos_sociales/' . $row->id_conflicto . '">
                                                    <img type="image" src="' . base_url() . '/assets/img/copiar.png" height="50px" title="Copiar Formulario">
                                                </a>';
    }

    public function registros_conflictos_sociales() {
        $usuario = $this->session->userdata('id_usuario');
        $crud = new grocery_CRUD();
// $crud->set_theme('datatables');
        $crud->set_table('conflictos_sociales');
        $crud->set_subject('conflictos_sociales');
//$crud->set_table('defensoria_na');
        //  $crud->where('id_usuario', $usuario);
        $crud->where('estado_aprobacion', 0);
        $crud->columns(
                'Eliminar Registro', 'Editar Registro', 'Aprobar Registro', 'Copiar Registro', 'id_conflicto', 'numero_formulario', 'cod_num', 'gestion', 'fecha_hecho', 'hora_hecho', 'mes', 'departamento', 'provincia', 'municipio', 'localidad', 'distrito', 'zona', 'lugar_hecho', 'pos_x', 'pos_y', 'epis', 'tipo_conflictos', 'sectores_grupos_movilizados', 'num_evento', 'resguardos_intervenciones', 'num_grupos_desplegados', 'remision_caso', 'servicio_destacado');

        /*   $crud->display_as('id_tipologia_principal', 'Tipologia Principal')
          ->display_as('id_tipologia_secundaria', 'Tipologia Secundaria') */
        ...
        $crud->set_relation('tipo_conflictos', 'tipo_conflictos', 'nombre_tipo_conflictos');
        $crud->set_relation('sectores_grupos_movilizados', 'sectores_grupos_movilizados', 'nombre_sectores_grupos_movilizados');
        $crud->set_relation('resguardos_intervenciones', 'resguardos_intervenciones', 'nombre_resguardos_intervenciones');
        $crud->set_relation('remision_caso', 'remision_caso', 'nombre_remision_caso');
        ...
        $data = array(
            "provincias" => $this->conflictos_sociales_model->getProvincias(),
            "gestion" => $this->conflictos_sociales_model->gestion(),
            "mes" => $this->conflictos_sociales_model->mes(),
            "departamento" => $this->conflictos_sociales_model->departamento(),
            "provincia" => $this->conflictos_sociales_model->provincia(),
            "municipio" => $this->conflictos_sociales_model->municipio(),
            "localidad" => $this->conflictos_sociales_model->localidad(),
            "epis" => $this->conflictos_sociales_model->epis(),
            "nacionalidad" => $this->conflictos_sociales_model->nacionalidad(),
            "tipo_servicio_extraordinario" => $this->conflictos_sociales_model->tipo_servicio_extraordinario(),
            "tipo_conflictos" => $this->conflictos_sociales_model->tipo_conflictos(),
            "sectores_grupos_movilizados" => $this->conflictos_sociales_model->sectores_grupos_movilizados(),
            "resguardos_intervenciones" => $this->conflictos_sociales_model->resguardos_intervenciones(),
            "tipo_vehiculo" => $this->conflictos_sociales_model->tipo_vehiculo(),
            "servicio" => $this->conflictos_sociales_model->servicio(),
            "arrestado" => $this->conflictos_sociales_model->arrestado(),
            "sancion" => $this->conflictos_sociales_model->sancion(),
            "estado_caso" => $this->conflictos_sociales_model->estado_caso(),
            "remision_caso" => $this->conflictos_sociales_model->remision_caso(),
            "termino_prueba" => $this->conflictos_sociales_model->termino_prueba(),
            "recurso_apelacion" => $this->conflictos_sociales_model->recurso_apelacion(),
            "servicio_destacado" => $this->conflictos_sociales_model->servicio_destacado(),
                //  "faltas_contravenciones" => $this->servicio_extraordinario_model->faltas_contravenciones(),
        );
...
// $data["solicitud_compra"] = $this->observatorio_model->lista_operativos();
        ...
        $this->load->view('conflictos_sociales/registros_conflictos_sociales', $data);
    }

    public function guardar_conflictos_sociales() {


        $date = strtotime($this->input->post('fecha_hecho'));
        $dia = date("w", $date);

        $guardar_conflictos_sociales = array(
            ...
            'tipo_conflictos' => $this->input->post('tipo_conflictos'),
            'sectores_grupos_movilizados' => $this->input->post('sectores_grupos_movilizados'),
            'resguardos_intervenciones' => $this->input->post('resguardos_intervenciones'),
            'num_evento' => $this->input->post('num_evento'),
            'num_grupos_desplegados' => $this->input->post('num_grupos_desplegados'),
...
//  $id_distrito = $this->input->post('provincias');
        ...
        $this->conflictos_sociales_model->guardar_conflictos_sociales($guardar_conflictos_sociales);

        redirect(base_url() . 'conflictos_sociales/registros_conflictos_sociales');
    }

    public function update_conflictos_sociales() {
        ...
        $id_conflicto = $this->input->post('id_conflicto');
//  $id_distrito = $this->input->post('provincias');

        $this->servicio_extraordinario_model->update_conflictos_sociales($guardar_conflictos_sociales, $id_conflicto);

        redirect(base_url() . 'servicio_extraordinario/registros_servicio_extraordinario');
    }

    public function edicion_conflictos_sociales() {
        $data = array(
            "provincias" => $this->conflictos_sociales_model->getProvincias(),
            "gestion" => $this->conflictos_sociales_model->gestion(),
            "mes" => $this->conflictos_sociales_model->mes(),
        ...
        $id_conflicto = $this->uri->segment(3);

        $edit = $this->conflictos_sociales_model->conflictos_sociales_edit($id_conflicto);
        foreach ($edit as $e):
//$e->pos_x;
        endforeach;


        $this->load->view('distritos/distritos_edit_conflictos_sociales', $edit);
...
//tendremos disponible en la vista mapa_view con el array data
        ...
        $data['datos'] = $this->mapa_model->get_markers_general_monitoreo_ubicacion();
        $data['edit'] = $this->conflictos_sociales_model->conflictos_sociales_edit($id_conflicto);
        $data['map'] = $this->googlemaps->create_map();
...
// $data["solicitud_compra"] = $this->observatorio_model->lista_operativos();
        $data['titulo'] = 'Bienvenido de nuevo ' . $this->session->userdata('perfil');
        $this->load->view('header');
        $this->load->view('conflictos_sociales/editar_conflictos_sociales', $data);
    }

    public function copiar_conflictos_sociales() {
       $data = array(
            "provincias" => $this->conflictos_sociales_model->getProvincias(),
            "gestion" => $this->conflictos_sociales_model->gestion(),
            "mes" => $this->conflictos_sociales_model->mes(),
...
//tendremos disponible en la vista mapa_view con el array data
        ...
        $data['datos'] = $this->mapa_model->get_markers_general_monitoreo_ubicacion();
        $data['edit'] = $this->conflictos_sociales_model->conflictos_sociales_edit($id_servicio);
        $data['map'] = $this->googlemaps->create_map();
...
// $data["solicitud_compra"] = $this->observatorio_model->lista_operativos();
        $data['titulo'] = 'Bienvenido de nuevo ' . $this->session->userdata('perfil');
        $this->load->view('header');
        $this->load->view('conflictos_sociales/copiar_conflictos_sociales', $data);
    }
...
// $data['tipo_operativo'] = $this->mapa_model->tipo_operativo($tipo_operativo);
    ...
    public function lista_exportar_faltas_contravenciones() {
        $usuario = $this->session->userdata('id_usuario');
        $crud = new grocery_CRUD();
// $crud->set_theme('datatables');
...
//$crud->set_table('defensoria_na');
        $crud->where('id_usuario', $usuario);
        $crud->columns('id_faltas', 'numero_formulario', 'cod_num', 'gestion', 'fecha_hecho', 'hora_hecho', 'mes', 'departamento', 'provincia', 'municipio', 'localidad', 'epis', 'distrito', 'zona', 'lugar_hecho', 'pos_x', 'pos_y', 'denuncia', 'nombre_victima', 'ci_victima', 'ciudad_victima', 'ciudad_victima', 'nacionalidad_victima', 'edad_victima', 'sexo_victima', 'telefono_victima', 'temperancia_victima', 'descripcion_falta', 'nombre_infractor', 'ci_infractor', 'categoria_licencia', 'ciudad_infractor', 'nacionalidad_infractor', 'edad_infractor', 'sexo_infractor', 'telefono_infractor', 'tipo_vehiculo', 'placa', 'servicio', 'temperancia_infractor', 'arrestado_infractor', 'sancion', 'estado_caso', 'termino_prueba', 'recurso_apelacion', 'numero_caso', 'arma_utilizada');
        ...
        $crud->set_relation('sexo_infractor', 'genero_infractor', 'nombre_genero_infractor');
        ...
        $data['titulo'] = 'Bienvenido de nuevo ' . $this->session->userdata('perfil');
        $this->load->view('header', $output);
        $this->load->view('faltas_contravenciones/lista_exportar', $data);
    }
